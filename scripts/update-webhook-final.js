...
console.log('🤖 Final Webhook Update');
console.log('======================');
...
async function main() {
  ...
  try {
    ...
    console.log('🌐 Dashboard: https://farastele-cfog7guq4-frxadz-6046s-projects.vercel.app');
    console.log('\n📋 Next steps:');
    console.log('1. Setup environment variables in Vercel Dashboard');
    console.log('2. Test bot: https://t.me/Backup_indBot');
    console.log('3. Test dashboard: https://farastele-cfog7guq4-frxadz-6046s-projects.vercel.app');
